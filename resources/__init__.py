""" KanishkaXJungli 2022-2023 © KanishkaXJungli """
...
def clear(fast=False):
    os.system("clear")
    if fast:
        print(KanishkaXJungli_logo)
    else:
        sprint(KanishkaXJungli_logo, 0.01)
...
def KanishkaXJungli_Setup():
    os.system("pip3 install python-dotenv[cli]")
    clear()
    print(f'    {white}KanishkaXJungli Version: v0.5 \n    {white}By Krishna')
...
def get_start():
    clear(fast=True)
    question = input(f"{ask}Wanna start KanishkaXJungli Now?: y/n: ")
    if question.lower() == "y":
        os.system("pip3 install python-dotenv")
        os.system("python3 -m KanishkaXJungli")
    elif question.lower() == "n":
        print(f"\n{info}Nevermind !! You Can Start It Later With by using; python3-m KanishkaXJungli\n")
        exit(2)
    else:
        os.system("clear")
