...
from Krishna.functions import check_logchannel
...
if not API_ID:
   print("KanishkaXJungli [INFO]: You didn't fill API_ID var!")
   sys.exit()
API_HASH = os.getenv("API_HASH", "")
if not API_HASH:
   print("KanishkaXJungli [INFO]: You didn't fill API_HASH var!")
   sys.exit()
...
if not CLIENT:
   print("KanishkaXJungli [INFO]: You have to fill CLIENT var!")
   sys.exit()
...
if LOGS_CHANNEL:
   if check_logchannel(LOGS_CHANNEL):
      print("KanishkaXJungli [INFO]: You Can't Use That Chat As A Log Channel -!")
      print("KanishkaXJungli [INFO]: Change Logs Channel Id else Bot Could not be start")
      sys.exit()
...
if not OWNER_ID:
   print("KanishkaXJungli [INFO]: You didn't fill OWNER_ID var!")
   sys.exit()
