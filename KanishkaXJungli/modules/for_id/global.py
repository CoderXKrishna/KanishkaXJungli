...
async def gpromote_(KanishkaXJungli: Client, message: Message):
    chat = message.chat
    user = await get_user(KanishkaXJungli, message)
    await start_gpromote(KanishkaXJungli, message, user)
...
async def gdemote_(KanishkaXJungli: Client, message: Message):
    chat = message.chat
    user = await user_only(KanishkaXJungli, message, Owner, Sudos)
    await start_gdemote(KanishkaXJungli, message, user)
